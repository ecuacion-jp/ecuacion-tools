...
//
///**
// * Tests for the move case.
// */
//public class Test21_101_UnitTest_taskList_Move extends AbstractTestTool {
//
//  @BeforeClass
...
//
//  /**
//   * Basic pattern. from=file, to=file.
//   */
//  @Test
//  public void test01_valid_fromFile_toFile() throws IOException {
...
//
//  /**
//   * Basic pattern. from=file, to=directory.
//   */
//  @Test
//  public void test02_valid_fromFile_toDir() throws IOException {
//    new File(fu.concatFilePaths(TEST_HOME_PATH, "fromDir")).mkdirs();
//    File fromFile = (new File(fu.concatFilePaths(TEST_HOME_PATH, "fromDir", "test.txt")));
//    fromFile.createNewFile();
...
//
//  /**
//   * Basic pattern. from=directory, to=directory.
//   */
//  @Test
//  public void test03_valid_fromDir_toDir() throws IOException {
//    new File(fu.concatFilePaths(TEST_HOME_PATH, "fromDir")).mkdirs();
