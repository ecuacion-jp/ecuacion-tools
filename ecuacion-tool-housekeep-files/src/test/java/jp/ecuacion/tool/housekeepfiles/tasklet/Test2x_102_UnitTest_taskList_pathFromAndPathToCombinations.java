...
//
///**
// * Tests for taskPtn patterns that specify both From and To paths.<br>
// * There are multiple patterns, but the file operation at the end is the only difference;
// * all preceding steps follow the same logic. Copy is used as the representative case.
// */
//public class Test2x_102_UnitTest_taskList_pathFromAndPathToCombinations extends AbstractTestTool {
//
...
//
//  /**
//   * from=multiple files, to=directory.
//   */
//  @Test
